...
- *(Opcional para modo real)* Keycloak en `http://localhost:8080/auth` con realm `grupo-ne` y cliente `maintenance-app`
...
| Parámetro | Valor |
|---|---|
| URL del servidor | `http://localhost:8080/auth` |
| Realm | `grupo-ne` |
...
| `PATCH` | `/api/v1/spare-parts/:id/stock` | Ajustar stock |
